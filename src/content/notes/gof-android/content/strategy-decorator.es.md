...
locale: es
translationKey: gof-strategy-decorator
slug: strategy-decorator
title: 'Strategy & Decorator: A/B tests en runtime y capas aditivas'
summary: Strategy cambia algoritmos en runtime sin tocar la lógica de negocio; Decorator envuelve una interfaz para agregar una preocupación transversal a la vez.
order: 4
visibility: public
maturity: stable
...
**Strategy** responde: ¿_cuál_ algoritmo corre?
**Decorator** responde: ¿_qué envuelve_ al algoritmo?
...
Las cuatro reglas de Observer & State se mantienen en los 8:
