...
summary: Adapter envuelve cualquier SDK de terceros detrás de tu propia interfaz; Factory crea esas implementaciones de forma mockeable desde el día uno.
order: 3
visibility: public
maturity: stable
...
La Factory decide _cuál_ Adapter crear. El Adapter decide _cómo_ llamar al SDK. Tu lógica de negocio nunca toca ninguna de las dos decisiones.
...
Esos tres pares resuelven la estructura. El último resuelve el comportamiento: hacer A/B test en runtime sin reescrituras, y extender lo que una clase hace sin tocar jamás su lógica núcleo.
