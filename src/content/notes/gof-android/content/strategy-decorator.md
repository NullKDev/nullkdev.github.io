...
summary: Strategy switches algorithms at runtime without touching business logic; Decorator wraps an interface to add one cross-cutting concern at a time.
order: 4
visibility: public
maturity: stable
...
**Strategy** answers: _which_ algorithm runs?
**Decorator** answers: _what wraps around_ the algorithm?
...
The four rules from Observer & State hold across all 8:
