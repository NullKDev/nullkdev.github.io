...
summary: Build a Remote Compose document on the creation side, serialize it, and render it in an Android app with remote-player-view.
order: 1
visibility: public
maturity: growing
...
Now that we've covered what Remote Compose is and why it exists, let's build something real — a simple UI document, serialize it, and render it in an Android app.
