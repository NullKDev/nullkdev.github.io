---
parentDomain: notes
parentId: notes-remote-compose-es
documentId: getting-started
locale: es
translationKey: remote-compose-getting-started
slug: primeros-pasos
title: 'Primeros pasos con Remote Compose: un ejemplo práctico'
summary: Construye un documento Remote Compose en el lado de creación, serialízalo y renderízalo en una app Android con remote-player-view.
order: 1
visibility: public
maturity: growing
publishedAt: 2026-04-01
updatedAt: 2026-07-23
topics: [android, kotlin, compose]
references: []
evidence: []
protection: { mode: public }
---

Ahora que explicamos qué es Remote Compose y por qué existe, construimos algo real — un documento de UI simple, lo serializamos, y lo renderizamos en una app Android.
...
`remote-player-view` provee `RemoteComposePlayerView` — una `View` (no un Composable) que acepta un documento y lo renderiza. Puedes embeberlo en cualquier layout XML o en una UI Compose mediante `AndroidView`.
