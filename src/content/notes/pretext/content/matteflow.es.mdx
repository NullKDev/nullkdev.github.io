...
locale: es
translationKey: pretext-matteflow
slug: matteflow
title: 'Matteflow: texto que fluye alrededor de un bailarín'
summary: Un demo de canvas — extrae una silueta con un matte de distancia de color y luego fluye texto del artículo a su alrededor en cada fotograma con pretext.
order: 4
visibility: public
maturity: growing
publishedAt: 2026-04-04
updatedAt: 2026-07-23
topics: [javascript, performance, web, typography]
references: []
evidence: []
protection: { mode: public }
---

import MatteflowDemo from '@/components/demos/MatteflowDemo'
...
<MatteflowDemo client:only="react" />
...
_Este texto está basado en el [README de pretext](https://github.com/chenglou/pretext) y la librería original de Cheng Lou. El concepto de Matteflow es de [summerKK/Matteflow](https://github.com/summerKK/Matteflow)._
