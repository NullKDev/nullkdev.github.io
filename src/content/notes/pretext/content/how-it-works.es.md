...
summary: El modelo mental de dos fases — un oráculo de fuentes en canvas en prepare(), aritmética pura en layout() — y la API completa.
order: 2
visibility: public
maturity: growing
...
const prepared = prepare(
  'El reflow desaparece cuando sacas la medición del DOM.',
  '16px Inter',
)
```
...
const prepared = prepareWithSegments(
  'Cada token en streaming suma al costo de layout — a menos que uses pretext.',
  '18px "Helvetica Neue"',
)
...
La teoría es limpia. Los demos que siguen la hacen tangible.
