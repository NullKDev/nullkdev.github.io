...
summary: Qué es el layout reflow, exactamente qué lecturas lo desencadenan y por qué medir texto siempre es una lectura sucia.
order: 1
visibility: public
maturity: growing
...
El problema es que algunas operaciones de JavaScript _fuerzan_ al navegador a abandonar esa agrupación y computar el layout de inmediato, síncronamente, en medio de tu código. Esta computación síncrona forzada es el **layout reflow**.
