...
summary: A canvas demo — extract a foreground silhouette with a color-distance matte, then flow article text around it every frame with pretext.
order: 4
visibility: public
maturity: growing
...
_This piece is based on the [pretext README](https://github.com/chenglou/pretext) and Cheng Lou's original library. The Matteflow concept is from [summerKK/Matteflow](https://github.com/summerKK/Matteflow)._
