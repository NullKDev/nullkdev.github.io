...
```mermaid
flowchart TB
  scan[Corre el escaneo] --> code{Codigo de salida}
  code -- 0 --> pass[Politica cumplida · merge]
  code -- 1 --> findings[Hallazgos en el umbral · revisar]
  code -- 2 --> hold[Sin evidencia · retener la puerta]
```
