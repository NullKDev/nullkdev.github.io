...
*Click to enlarge - Carlosdev Homelab*
...
[Setup guide →](https://nullkdev.github.io//blog/tailscale-site-to-site/)

**Unbound DNS**
Local recursive resolver with domain overrides for `*.k8s.nullkdev.github.io` pointing to K8s-Gateway.
...
| **carlosdevos** | Docker host for simpler services | 4vCPU/8GB/500GB | Alternative to Kubernetes complexity |
...
<Callout variant="tip">
**Pro tip:** For Dell R720 fan control details, check out my [dedicated post](https://nullkdev.github.io//blog/dell-r720/)
</Callout>
...
All managed through a single Portainer instance at `cloud.nullkdev.github.io`:
...
Fork and customize: 👉 [github.com/carlosdevdotdev/infrastructure](https://github.com/carlosdevdotdev/infrastructure)
...
| **Talos Patches** | [Custom machine config](https://github.com/carlosdevdotdev/infrastructure/blob/main/talos/patches/global/machine-longhorn.yaml) | Longhorn requirements |
