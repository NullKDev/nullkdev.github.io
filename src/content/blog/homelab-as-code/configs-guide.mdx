...
```yaml
- "traefik.http.routers.jellyseer-media.rule=Host(`jellyseer.carlosdev.cloud`)"
```

This ensures the services are accessible at `jellyseer.carlosdev.cloud` or any domain configured in your environment.
