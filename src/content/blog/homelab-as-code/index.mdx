...
**💻 Source Code**: [carlosdevdotdev/homelab-as-code](https://github.com/carlosdevdotdev/homelab-as-code)
...
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/carlosdevdotdev/homelab-as-code/refs/heads/master/deploy_homelab.sh)"
```
...
1. **Initial Prompts**  
   - First, the script will ask for the repository type (**public** or **private**).  
     - For a private repository, ensure you provide the SSH link (e.g., `git@github.com:carlosdevdotdev/homelab.git`) instead of HTTPS.
     - For a public repository, you can directly use this one tutorial-based: `https://github.com/carlosdevdotdev/homelab-as-code.git`
