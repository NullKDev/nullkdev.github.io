...
spec:
  ...
  nfs:
    ...
    server: storage.carlosdev.cloud
...
spec:
  entryPoints:
    - websecure
  routes:
    - match: Host(`movies.carlosdev.cloud`) # change to your domain
      kind: Rule
      services:
        - name: app # radarr for example 
          port: 80
...
[All manifest files 🔗](https://docs.nullkdev.github.io/operations/containerization/k3s/manifests/media-stack/)
