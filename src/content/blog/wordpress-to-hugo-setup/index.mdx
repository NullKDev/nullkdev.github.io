...
For over 6 months now, I've been all-in on Hugo—my current site [nullkdev.github.io](https://nullkdev.github.io/) runs entirely on it. I had totally underestimated the power of a static site. Hugo's written in Go, builds super fast, and is already SEO-optimized out of the box.
    ...
    steps:
      ...
      - name: Deploy
        ...
        with:
          ...
          external_repository: carlosdevdotdev/nullkdev.github.io
